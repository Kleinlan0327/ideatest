...
<div class="container">
    <div class="row">
        <div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
            <a href="${pageContext.request.contextPath}/static/index.htm">首页&nbsp;&nbsp;&gt;</a>
            <a href="${pageContext.request.contextPath}/static/蔬菜分类.htm">蔬菜&nbsp;&nbsp;&gt;</a>
            <a>无公害蔬菜</a>
        </div>

        <div style="margin:0 auto;width:950px;">
            <div class="col-md-6">
                <img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/static/image/r___________renleipic_01/bigPic5f3622b8-028a-4e62-a77f-f41a16d715ed.jpg">
            </div>
        ...
        <div style="width:950px;margin:0 auto;">
            ...
            <div>
                <img src="${pageContext.request.contextPath}/static/image/r___________renleipic_01/bigPic139f030b-d68b-41dd-be6d-b94cc568d3c5.jpg">
            </div>
